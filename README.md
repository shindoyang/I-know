...
框架的底层是java，java的底层是jvm虚拟机，而jvm虚拟机是参考计算机组成操作系统来整的。其他中间的间的思路也几乎差不多。
...
但是你的底层基础知识怎么办？你的jvm怎么办？你的**k8s**怎么办？ 还有你的linux系统啊，你渴望提高的vi技巧
...
go语言入门-->如果只是一直看，是没有办法彻底掌握的，要去试错
...
![image-20200902162618733](images/image-20200902162618733.png)
