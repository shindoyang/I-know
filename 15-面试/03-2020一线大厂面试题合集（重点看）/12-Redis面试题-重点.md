...
![Redis_Cluster方案](images/redis/Redis_Cluster方案.jpg)
...
![代里服务器分片](images/redis/代里服务器分片.jpg)
...
![主从复制原理](images/redis/主从复制原理.png)
...
返回值：设置成功，返回 1 。设置失败，返回 0 。![img](images/redis/img.jpg)
...
他进程如果发现有锁就等待，然后等解锁后返回数据或者进入DB查询常用工具
